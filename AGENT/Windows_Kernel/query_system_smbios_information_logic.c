        ...
        */
        ...
        case 1:
            ...
            */
            ...
            memcpy(Driver_ID.SMBIOS_TYPE_1, (PUCHAR)((PUCHAR)header + (ULONG32)header->Length), (offset - remember_start_offset )- header->Length ); // 하드웨어 타입 1 정보 저장
        ...
        case 2:
            ...
            */
            ...
            memcpy(Driver_ID.SMBIOS_TYPE_2, (PUCHAR)((PUCHAR)header + (ULONG32)header->Length), ((offset - header->Length) - remember_start_offset)); // 하드웨어 타입 2 정보 저장
